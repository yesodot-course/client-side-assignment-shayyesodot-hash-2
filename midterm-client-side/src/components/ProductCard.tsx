  ...
  return (
    ...
    >
      ...
      <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', gap: 1.5, p: 3 }}>
        <Typography variant="h6" sx={{ fontWeight: 700, lineHeight: 1.2, height: '2.4em', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' }}>
          {item.name}
        </Typography>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row-reverse' }}>
          ...
          <Typography variant="body2" color={item.stock > 0 ? "success.main" : "error.main"} sx={{ fontWeight: 600 }}>
