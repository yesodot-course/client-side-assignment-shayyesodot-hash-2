    ...
    <Container maxWidth="xl" sx={{ py: 4 }} dir="rtl">
      ...
      <Grid container spacing={4} sx={{ flexDirection: 'row-reverse' }}>
        ...
        <Grid size={{ xs: 12, md: 3 }}>
          ...
          >
            <Typography variant="h6" sx={{ mb: 3, fontWeight: 'bold' }}>חיפוש וסינון</Typography>
        ...
        <Grid size={{ xs: 12, md: 9 }}>
          {filteredItems.length === 0 ? (
            <Box sx={{ textAlign: 'center', py: 10 }}>
              <Typography variant="h5" color="text.secondary">לא נמצאו מוצרים התואמים לחיפוש שלך.</Typography>
            </Box>
          ) : (
            <Box
              sx={{
